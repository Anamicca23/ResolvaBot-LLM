...
if __name__ == "__main__":
    for i in range(1, 4):
        embeddings_path = f"D:/youtube downloads/3textbook/embeddings_textbook{i}.pkl"
        chunks_path = f"D:/youtube downloads/3textbook/chunks_textbook{i}.txt"
        ...
        raptor_path = f"D:/youtube downloads/3textbook/raptor_index_textbook{i}.pkl"
